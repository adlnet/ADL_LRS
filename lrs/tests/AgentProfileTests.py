...
class AgentProfileTests(TestCase):
    ...
    def tearDown(self):
        self.client.delete(reverse(agent_profile), self.testparams1, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        self.client.delete(reverse(agent_profile), self.testparams2, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        self.client.delete(reverse(agent_profile), self.testparams3, Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_put_etag_if_none_match_good(self):
        ...
        r = self.client.delete(reverse(agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_get(self):
        ...
        r2 = self.client.get(reverse(agent_profile), self.testparams2, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        ...
        r3 = self.client.get(reverse(agent_profile), self.testparams3, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        ...
        r4 = self.client.get(reverse(agent_profile), self.testparams4, Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_get_no_params(self):
        r = self.client.get(reverse(agent_profile), Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_get_agent_since(self):
        ...
        self.client.delete(reverse(agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_get_agent_since_tz(self):
        ...
        self.client.delete(reverse(agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        self.client.delete(reverse(agent_profile), params2, Authorization=self.auth, X_Experience_API_Version="1.0.0")
    ...
    def test_post_put_delete(self):
        ...
        self.assertEqual(response.status_code, 204)
        r = self.client.get(reverse(agent_profile), {"profileId": prof_id, "agent": self.testagent}, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        self.assertEqual(r.status_code, 200)
        import ast
    ...
    def test_group_as_agent(self):
        ...
        getr = self.client.get(reverse(agent_profile), testparams1, Authorization=self.auth, X_Experience_API_Version="1.0.0")
        ...
        self.client.delete(reverse(agent_profile), testparams1, Authorization=self.auth, X_Experience_API_Version="1.0.0")

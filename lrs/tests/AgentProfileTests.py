...
class AgentProfileTests(TestCase):
    ...
    def tearDown(self):
        self.client.delete(reverse(views.agent_profile), self.testparams1, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.client.delete(reverse(views.agent_profile), self.testparams2, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.client.delete(reverse(views.agent_profile), self.testparams3, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.client.delete(reverse(views.agent_profile), self.testparams4, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_get_agent_not_found(self):
        ...
        r = self.client.get(reverse(views.agent_profile), param, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_put_etag_missing_on_change(self):
        ...
        r = self.client.get(reverse(views.agent_profile), self.testparams1, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_put_etag_if_none_match_good(self):
        ...
        r = self.client.get(reverse(views.agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.assertEqual(r.status_code, 200)
        self.assertEqual(r.content, '%s' % profile)

        r = self.client.delete(reverse(views.agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_get(self):
        ...
        r2 = self.client.get(reverse(views.agent_profile), self.testparams2, Authorization=self.auth, X_Experience_API_Version="1.0")
        ...
        r3 = self.client.get(reverse(views.agent_profile), self.testparams3, Authorization=self.auth, X_Experience_API_Version="1.0")
        ...
        r4 = self.client.get(reverse(views.agent_profile), self.testparams4, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_get_no_params(self):
        r = self.client.get(reverse(views.agent_profile), Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_get_agent_since(self):
        ...
        response = self.client.put(path, profile, content_type=self.content_type, updated=updated.isoformat(), Authorization=self.auth, X_Experience_API_Version="1.0")
        ...
        r2 = self.client.get(reverse(views.agent_profile), params2, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.assertNotIn(prof_id, r2.content)

        self.client.delete(reverse(views.agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_get_agent_since_tz(self):
        ...
        response = self.client.put(path2, profile2, content_type=self.content_type, updated=updated2, Authorization=self.auth, X_Experience_API_Version="1.0")
        ...
        r = self.client.get(reverse(views.agent_profile), par, Authorization=self.auth, X_Experience_API_Version="1.0")

        self.assertNotIn(prof_id, r.content)
        self.assertIn(prof_id2, r.content)

        self.client.delete(reverse(views.agent_profile), params, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.client.delete(reverse(views.agent_profile), params2, Authorization=self.auth, X_Experience_API_Version="1.0")
    ...
    def test_post_put_delete(self):
        ...
        response = self.client.post(path, params, content_type="application/x-www-form-urlencoded", Authorization=self.auth, X_Experience_API_Version="1.0")
        # pdb.set_trace()
        r = self.client.get(reverse(views.agent_profile), {"profileId": prof_id, "agent": self.testagent}, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.assertEqual(r.status_code, 200)
        ...
        r = self.client.post(path, dparams,content_type="application/x-www-form-urlencoded", Authorization=self.auth, X_Experience_API_Version="1.0")
        self.assertEqual(r.status_code, 204)
    ...
    def test_group_as_agent(self):
        ...
        put1 = self.client.put(path, testprofile, content_type=self.content_type, Authorization=self.auth, X_Experience_API_Version="1.0")

        self.assertEqual(put1.status_code, 204)

        getr = self.client.get(reverse(views.agent_profile), testparams1, Authorization=self.auth, X_Experience_API_Version="1.0")
        self.assertEqual(getr.status_code, 200)
        self.assertEqual(getr.content, '%s' % testprofile)

        self.client.delete(reverse(views.agent_profile), testparams1, Authorization=self.auth, X_Experience_API_Version="1.0")

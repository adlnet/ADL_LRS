...
class AuthTests(TestCase):
    ...
    def test_since_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        sinceGetResponse = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_until_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        untilGetResponse = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_activity_object_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        activityObjectGetResponse = self.client.get(path, X_Experience_API_Version="1.0.0", 
    ...
    def test_no_actor(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        actorObjectGetResponse = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_verb_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        verb_response = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_statement_ref_object_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        sub_object_get_response = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_registration_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        registrationPostResponse = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_ascending_filter(self):
        ...
        ascending_get_response = self.client.get(reverse(views.statements), 
            {"ascending": True},content_type="application/x-www-form-urlencoded", X_Experience_API_Version="1.0.0", )
    ...
    def test_actor_filter(self):
        ...
        actorGetResponse = self.client.post(reverse(views.statements), 
            {"actor":{"objectType": "Agent", "mbox":"mailto:s@s.com"}},
             content_type="application/x-www-form-urlencoded", X_Experience_API_Version="1.0.0", )
    ...
    def test_authoritative_filter(self):
        ...
        auth_get_response = self.client.get(path, X_Experience_API_Version="1.0.0", )        
    ...
    def test_limit_filter(self):
        # Test limit
        limitGetResponse = self.client.post(reverse(views.statements),{"limit":1}, content_type="application/x-www-form-urlencoded", X_Experience_API_Version="1.0.0", )
    ...
    def test_sparse_filter(self):
        # Test sparse
        sparseGetResponse = self.client.post(reverse(views.statements),{"sparse": False}, content_type="application/x-www-form-urlencoded", X_Experience_API_Version="1.0.0", )
    ...
    def test_linked_filters(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        linkedGetResponse = self.client.get(path, X_Experience_API_Version="1.0.0", )
    ...
    def test_language_header_filter(self):
        ...
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        
        lang_get_response = self.client.get(path, Accept_Language="en-US", X_Experience_API_Version="1.0.0", )

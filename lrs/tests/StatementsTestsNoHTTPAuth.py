...
class StatementsTestsNoHTTPAuth(TestCase):
    def setUp(self):
    ...
    def test_linked_filters(self):
        ...
        param = {"verb":"http://adlnet.gov/expapi/verbs/created", "object":{"objectType": "Activity", "id":"foogie"}, "since":self.secondTime, "sparse": False}
        path = "%s?%s" % (reverse(views.statements), urllib.urlencode(param))        

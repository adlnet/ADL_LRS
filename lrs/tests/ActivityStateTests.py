...
class ActivityStateTests(TestCase):
    ...
    def test_ie_cors_put_delete(self):
        ...
        param = "stateId=%s&activityId=%s&agent=%s&content=%s&Content-Type=application/x-www-form-urlencoded&Authorization=%s&X-Experience-API-Version=0.95" % (sid, self.activityId, testagent, content, auth)
        ...
        dparam = "agent=%s&activityId=%s&Authorization=%s&Content-Type=application/x-www-form-urlencoded&X-Experience-API-Version=0.95" % (testagent,self.activityId,auth)

...
class StatementManagerTests(TestCase):
    ...
    def test_context_activity_list(self):
        ...
        context_activities = StatementContextActivity.objects.filter(statement=stmt)
    ...
    def test_context_statement_delete(self):
        ...
        self.assertEqual(len(Agent.objects.all()), 5)
        self.assertEqual(len(Verb.objects.all()), 1)
        ...
        self.assertEqual(len(Verb.objects.all()), 1)
        self.assertEqual(len(Activity.objects.all()), 3)
        self.assertIn('act:activity', Activity.objects.values_list('activity_id', flat=True))
    ...
    def test_context_in_another_context_statement_delete(self):
        ...
        self.assertEqual(len(Activity.objects.all()), 6)
        self.assertEqual(len(Agent.objects.all()), 8)
        self.assertEqual(len(Verb.objects.all()), 3)
        self.assertEqual(len(StatementContextActivity.objects.all()), 6)
        ...
        self.assertEqual(len(Agent.objects.all()), 8)        
        self.assertEqual(len(Verb.objects.all()), 3)
        self.assertEqual(len(StatementContextActivity.objects.all()), 4)
        self.assertEqual(len(Statement.objects.all()), 2)
        ...
        self.assertEqual(len(Agent.objects.all()), 8)        
        self.assertEqual(len(Verb.objects.all()), 3)
        self.assertEqual(len(StatementContextActivity.objects.all()), 2)
        self.assertEqual(len(Statement.objects.all()), 1)
        ...
        self.assertEqual(len(Agent.objects.all()), 8)        
        self.assertEqual(len(Verb.objects.all()), 3)
        self.assertEqual(len(StatementContextActivity.objects.all()), 0)
    ...
    def test_simple_statement_delete(self):
        ...
        self.assertEqual(len(Agent.objects.all()), 3)
        ...
        self.assertEqual(len(Verb.objects.all()), 1)
        self.assertEqual(len(Statement.objects.all()), 1)
        self.assertEqual(Statement.objects.all()[0].id, stmt1.id)
    ...
    def test_more_conacts_delete(self):
        ...
        self.assertEqual(len(Agent.objects.all()), 3)
        self.assertEqual(len(Activity.objects.all()), 2)
        self.assertEqual(len(Verb.objects.all()), 1)
        self.assertEqual(len(Statement.objects.all()), 2)
    ...
    def test_activity_also_in_conact(self):
        ...
        agents = Agent.objects.values_list('mbox', flat=True)
        self.assertIn('mailto:a@a.com', agents)
        self.assertIn('mailto:inst@inst.com', agents)
        
        acts = Activity.objects.values_list('activity_id', flat=True)
        self.assertIn('act:activity1', acts)
        self.assertIn('act:activity2', acts)
        self.assertEqual(Verb.objects.all()[0].verb_id, 'verb:verb/url')
        self.assertEqual(Statement.objects.all()[0].id, stmt1.id)
    ...
    def test_sub_delete(self):
        ...
        self.assertEqual(len(Statement.objects.all()), 4)
        self.assertEqual(len(Agent.objects.all()), 9)
        ...
        self.assertEqual(len(StatementContextActivity.objects.all()), 1)
        self.assertEqual(len(SubStatementContextActivity.objects.all()), 1)
        ...
        self.assertEqual(len(StatementRef.objects.all()), 0)
        self.assertEqual(len(StatementContextActivity.objects.all()), 0)
        self.assertEqual(len(SubStatementContextActivity.objects.all()), 0)

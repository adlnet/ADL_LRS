...
class StatementsMoreTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client.post(reverse(views.register),form)
        ...
        models.Statement.objects.filter(statement_id=self.guid25).update(stored=time)

...
class ActivityModelsTests(TestCase):        
    ...
    # fields
    def do_activity_definition_model(self, fk, test_name_key, test_name_value, test_desc_key,
                                     test_desc_value,course, intType):
        act_def = models.activity_definition.objects.filter(activity=fk)[0]
        name_lang_map = act_def.name
        desc_lang_map = act_def.description

        self.assertEqual(name_lang_map.key, test_name_key)
        self.assertEqual(name_lang_map.value, test_name_value)
        self.assertEqual(desc_lang_map.key, test_desc_key)
        self.assertEqual(desc_lang_map.value, test_desc_value)
    ...
    def test_activity_no_def_not_link_schema_conform(self):
        ...
        self.do_activity_definition_model(fk, 'en-FR','Example Name', 'en-US', 'Example Desc', 'module',
                                          'course')
    ...
    def test_activity_no_def_not_link_schema_conform_extensions(self):
        ...
        self.do_activity_definition_model(fk, 'en-US','Example Name', 'en-US','Example Desc', 'module',
            'course')

        self.do_activity_definition_extensions_model(def_fk, 'keya', 'keyb', 'keyc','first value',
    ...
    def test_activity_not_link_no_resolve(self):
        ...
        self.do_activity_definition_model(fk, 'en-CH','testname', 'en-US','testdesc', 'course', 'intType')
    ...
    def test_activity_link_resolve(self):
        ...
        self.do_activity_definition_model(fk, 'en-GB','testname', 'en-GB','testdesc1', 'link', 'intType')
    ...
    def test_activity_definition(self):
        ...
        self.do_activity_definition_model(fk, 'en-GB','testname', 'en-US','testdesc', 'course', 'intType')
    ...
    def test_activity_definition_extensions(self):
        ...
        self.do_activity_definition_model(fk, 'en-FR','testname2', 'en-CH','testdesc2', 'course',
                'intType2')
    ...
    def test_activity_definition_cmiInteraction_true_false(self):
        ...
        self.do_activity_definition_model(fk, 'en-FR','testname2', 'en-US','testdesc2', 'cmi.interaction',
                                          'true-false')

        self.do_activity_definition_extensions_model(def_fk, 'key1', 'key2', 'key3', 'value1',
                                                    'value2', 'value3')
    ...
    def test_activity_definition_cmiInteraction_multiple_choice(self):    
        act = Activity.Activity(json.dumps({'objectType': 'Activity', 'id':'foof',
                ...
                'description': {'en-US': 'Scrabble Example'}}],'extensions': {'key1': 'value1',
                'key2': 'value2','key3': 'value3'}}}))
        ...
        self.do_activity_definition_model(fk, 'en-US', 'testname1', 'en-US', 'testdesc1',
                                          'cmi.interaction', 'multiple-choice')
    ...
    def test_activity_definition_cmiInteraction_fill_in(self):
        ...
        self.do_activity_definition_model(fk, 'en-FR','testname2', 'en-FR','testdesc2', 'cmi.interaction',
                                          'fill-in')
    ...
    def test_activity_definition_cmiInteraction_likert(self):    
        act = Activity.Activity(json.dumps({'objectType': 'Still gonna be activity', 'id':'fooi',
                ...
                'description': {'en-US':'Its OK'}},{'id': 'likert_1',
                'description':{'en-US': 'Its Pretty Cool'}}, {'id':'likert_2',
                'description':{'en-US':'Its Cool Cool'}},
        ...
        self.do_activity_definition_model(fk, 'en-CH','testname2', 'en-CH','testdesc2', 'cmi.interaction',
                                          'likert')
    ...
    def test_activity_definition_cmiInteraction_performance(self):    
        ...
        self.do_activity_definition_model(fk, 'en-us','testname2', 'en-us','testdesc2', 'cmi.interaction',
                                          'performance')
    ...
    def test_activity_definition_cmiInteraction_sequencing(self):    
        ...
        self.do_activity_definition_model(fk, 'en-GB','testname2', 'en-GB','testdesc2', 'cmi.interaction',
                                          'sequencing')
    ...
    def test_language_map_description_name(self):
        ...
        self.do_activity_definition_model(fk, 'en-US','actname', 'en-us','actdesc', 'cmi.interaction',
                                          'other')
    ...
    def test_multiple_activities_update_name(self):
        ...
        self.do_activity_definition_model(fk1, 'en-us','actname2', 'en-us','actdesc', 'cmi.interaction',
                                          'other')

        fk2 = models.activity.objects.filter(id=act2.activity.id)[0]
        self.do_activity_model(act2.activity.id, 'foob', 'Activity')
        self.do_activity_definition_model(fk2, 'en-us','actname2', 'en-us','actdesc', 'cmi.interaction',
                                          'other')
    ...
    def test_multiple_activities_update_desc(self):
        ...
        act2 = Activity.Activity(json.dumps({'objectType':'Activity', 'id': 'foob',
            'definition':{'name': {'en-US':'actname'},'description': {'en-FR':'actdesc2'}, 
            'type': 'cmi.interaction','interactionType': 'other','correctResponsesPattern': ['(35,-86)']}}))

        fk1 = models.activity.objects.filter(id=act1.activity.id)[0]
        self.do_activity_model(act1.activity.id, 'foob', 'Activity')
        self.do_activity_definition_model(fk1, 'en-US','actname', 'en-FR','actdesc2', 'cmi.interaction',
                                          'other')

        fk2 = models.activity.objects.filter(id=act2.activity.id)[0]
        self.do_activity_model(act2.activity.id, 'foob', 'Activity')
        self.do_activity_definition_model(fk2, 'en-US','actname', 'en-FR','actdesc2', 'cmi.interaction',
                                          'other')
    ...
    def test_multiple_activities_update_both(self):
        ...
        fk1 = models.activity.objects.filter(id=act1.activity.id)[0]
        self.do_activity_model(act1.activity.id, 'foob', 'Activity')
        self.do_activity_definition_model(fk1, 'en-CH','actname2', 'en-FR','actdesc2', 'cmi.interaction',
                                          'other')

        fk2 = models.activity.objects.filter(id=act2.activity.id)[0]
        self.do_activity_model(act2.activity.id, 'foob', 'Activity')
        self.do_activity_definition_model(fk2, 'en-CH','actname2', 'en-FR','actdesc2', 'cmi.interaction',
                                          'other')

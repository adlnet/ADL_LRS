...
def statements_post(req_dict):
    ...
    # check_statement_hooks(stmt_ids)
...
#     actorQ, verbQ, objectQ, relatedQ = Q(), Q(), Q(), Q()
...
#             if 'id' in ob:
#                 if or_operand:
#                     objectQ = objectQ | (Q(context_ca_parent__activity_id=ob['id']) \
#                     | Q(context_ca_grouping__activity_id=ob['id']) \
#                     | Q(context_ca_category__activity_id=ob['id']) \
#                     | Q(context_ca_other__activity_id=ob['id']) \
#                     | Q(object_substatement__object_activity__activity_id=ob['id']) \
#                     | Q(object_substatement__context_ca_parent__activity_id=ob['id']) \
#                     | Q(object_substatement__context_ca_grouping__activity_id=ob['id']) \
#                     | Q(object_substatement__context_ca_category__activity_id=ob['id']) \
#                     | Q(object_substatement__context_ca_other__activity_id=ob['id']))
#                 else:
#                     objectQ = objectQ & (Q(context_ca_parent__activity_id=ob['id']) \
#                     | Q(context_ca_grouping__activity_id=ob['id']) \
#                     | Q(context_ca_category__activity_id=ob['id']) \
...
#                 if or_operand:
#                     objectQ = objectQ | (Q(object_agent=agent) | Q(authority=agent) \
